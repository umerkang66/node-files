      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 12:
            ...
            (0, _alerts.showAlert)('error', _context2.t0.message || 'Error logging out');
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoidW1hcmthbmc0NSIsImEiOiJjbDA0b3Rqc3Mwbnh2M2ltanNoNmdmYnB4In0.Ra80ir_zZO8dmQQ6PnRPJQ';
...
var stripe = Stripe('pk_test_51KYQXuAIyv4mhoG98hEVReWBIaNJ8d34UbEbHKqwx6h6qSU5MxLpxtEyxSnqJscc75cAuHXe9HIRX0k0oreaYtMb00XaAy1onU');
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              buttonEl = document.querySelector('.btn--login');
    ...
    var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(event) {
      ...
      return regeneratorRuntime.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              event.preventDefault(); // Images are sent through form data, the data other that files in formData will be automatically be sent in the req.body, and files in req.file
              ...
              console.log(form);
              buttonEl = document.querySelector('.btn--save-settings');
              buttonEl.textContent = 'Processing...';
              buttonEl.style.opacity = 0.7;
              _context2.next = 11;
...
if (updatePasswordForm) {
  updatePasswordForm.addEventListener('submit', /*#__PURE__*/function () {
    var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(event) {
      var passwordCurrentEl, passwordEl, passwordConfirmEl, buttonEl, passwordCurrent, password, passwordConfirm;
      return regeneratorRuntime.wrap(function _callee3$(_context3) {
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              event.preventDefault();
              passwordCurrentEl = document.getElementById('password-current');
              passwordEl = document.getElementById('password');
              passwordConfirmEl = document.getElementById('password-confirm');
              buttonEl = document.querySelector('.btn--save-password');
